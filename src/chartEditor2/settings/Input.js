goog.provide('anychart.chartEditor2Module.settings.Input');
 ...
 */
anychart.chartEditor2Module.settings.Input = function(opt_label, opt_domHelper) {
  anychart.chartEditor2Module.settings.Input.base(this, 'constructor', opt_label, opt_domHelper);
...
goog.inherits(anychart.chartEditor2Module.settings.Input, goog.ui.LabelInput);
 ...
 * value.
 */
anychart.chartEditor2Module.settings.Input.prototype.labelCssClassName =
 ...
 * @private
 */
anychart.chartEditor2Module.settings.Input.prototype.key_ = '';
 ...
 * @private
 */
anychart.chartEditor2Module.settings.Input.prototype.keyHandler_ = null;


/** @param {string|Array.<string>} value */
anychart.chartEditor2Module.settings.Input.prototype.setKey = function(value) {
  this.key_ = value;
};
 ...
 * @override
 */
anychart.chartEditor2Module.settings.Input.prototype.createDom = function() {
...
/** @inheritDoc */
anychart.chartEditor2Module.settings.Input.prototype.disposeInternal = function() {
  if (this.keyHandler_) {
  ...
  anychart.chartEditor2Module.settings.Input.base(this, 'disposeInternal');
};


/** @inheritDoc */
anychart.chartEditor2Module.settings.Input.prototype.enterDocument = function() {
  anychart.chartEditor2Module.settings.Input.base(this, 'enterDocument');
...
anychart.chartEditor2Module.settings.Input.prototype.update = function(model) {
...
/** @private */
anychart.chartEditor2Module.settings.Input.prototype.onKeyPress_ = function() {
