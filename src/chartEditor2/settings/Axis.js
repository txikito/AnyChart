 ...
 */
anychart.chartEditor2Module.settings.Axis = function() {
  anychart.chartEditor2Module.settings.Axis.base(this, 'constructor');

  this.enabled_ = true;
};
goog.inherits(anychart.chartEditor2Module.settings.Axis, goog.ui.Component);
 ...
 * @type {string}
 */
anychart.chartEditor2Module.settings.Axis.CSS_CLASS = goog.getCssName('anychart-chart-editor-settings-axis');
 ...
 * @private
 */
anychart.chartEditor2Module.settings.Axis.prototype.name_ = 'Axis';


/** @param {string} value */
anychart.chartEditor2Module.settings.Axis.prototype.setName = function(value) {
  this.name_ = value;
};
 ...
 * @private
 */
anychart.chartEditor2Module.settings.Axis.prototype.showName_ = true;


/** @param {boolean} value */
anychart.chartEditor2Module.settings.Axis.prototype.showName = function(value) {
 ...
 * @private
 */
anychart.chartEditor2Module.settings.Axis.prototype.index_ = 0;


/** @param {number} value */
anychart.chartEditor2Module.settings.Axis.prototype.setIndex = function(value) {
 ...
 * @private
 */
anychart.chartEditor2Module.settings.Axis.prototype.key_ = 'axis';


/** @param {string} value */
anychart.chartEditor2Module.settings.Axis.prototype.setKey = function(value) {
  if (value != this.key_) {
    this.key_ = value;
    this.updateKeys();
  }
 ...
 *     Axis settings.
 */
anychart.chartEditor2Module.settings.Axis.prototype.setEnabled = function(enabled) {
  if (enabled) {
 ...
 */
anychart.chartEditor2Module.settings.Axis.prototype.isEnabled = function() {
...
anychart.chartEditor2Module.settings.Axis.prototype.createDom = function() {
  ...
  var invertedBtn = new anychart.chartEditor2Module.checkbox.Base();
  ...
  //region Labels
  var labels = new anychart.chartEditor2Module.settings.Title();
 ...
 */
anychart.chartEditor2Module.settings.Axis.prototype.update = function(model) {
 ...
 * @return {string}
 */
anychart.chartEditor2Module.settings.Axis.prototype.genKey = function(value) {
