 ...
 * @private
 */
anychart.chartEditor2Module.colorPicker.Base.prototype.key_ = '';
...
anychart.chartEditor2Module.colorPicker.Base.prototype.update = function(model) {
  var color = anychart.chartEditor2Module.Controller.getset(model, goog.isArray(this.key_) ? this.key_[0] : this.key_);
