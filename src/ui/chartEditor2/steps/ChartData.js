goog.provide('anychart.ui.chartEditor2.steps.Data');

goog.require('anychart.ui.chartEditor2.DataMappings');
 ...
 */
anychart.ui.chartEditor2.steps.Data = function(opt_domHelper) {
  anychart.ui.chartEditor2.steps.Data.base(this, 'constructor', opt_domHelper);

  /**
   * @type {anychart.ui.chartEditor2.DataMappings}
   * @private
   */
...
goog.inherits(anychart.ui.chartEditor2.steps.Data, anychart.ui.chartEditor2.steps.Base);
 ...
 * @type {string}
 */
anychart.ui.chartEditor2.steps.Data.CSS_CLASS = goog.getCssName('anychart-chart-editor-data-step');
 ...
 * @private
 */
anychart.ui.chartEditor2.steps.Data.DATA_SET_DATA_ATTRIBUTE_ = 'data-index';


/** @override */
anychart.ui.chartEditor2.steps.Data.prototype.createDom = function() {
  anychart.ui.chartEditor2.steps.Data.base(this, 'createDom');

  var element = /** @type {Element} */(this.getElement());
  var dom = this.getDomHelper();

  var className = anychart.ui.chartEditor2.steps.Data.CSS_CLASS;
 ...
 * @private
 */
anychart.ui.chartEditor2.steps.Data.prototype.updateDataSets_ = function() {
  var dom = this.getDomHelper();
  var className = anychart.ui.chartEditor2.steps.Data.CSS_CLASS;
  ...
  for (var i = 0; i < sharedModel.dataSets.length; i++) {
    ...
    dataSetEl = dom.createDom(
        ...
        dataSet.name);
    dataSetEl.setAttribute(anychart.ui.chartEditor2.steps.Data.DATA_SET_DATA_ATTRIBUTE_, String(dataSet.index));
 ...
 * @private
 */
anychart.ui.chartEditor2.steps.Data.prototype.updateDataPreview_ = function(index) {
  var sharedModel = this.getSharedModel();
 ...
 * @private
 */
anychart.ui.chartEditor2.steps.Data.prototype.updateDataMappings_ = function(index) {
  ...
  if (goog.isArrayLike(rawData[0]) || goog.isObject(rawData[0])) {
    this.dataMappings_ = new anychart.ui.chartEditor2.DataMappings(dataSet);
 ...
 * @private
 */
anychart.ui.chartEditor2.steps.Data.prototype.selectDataSet_ = function(index) {
  var sharedModel = this.getSharedModel();
 ...
 * @private
 */
anychart.ui.chartEditor2.steps.Data.prototype.dataSetsClickHandler_ = function(e) {
  var className = anychart.ui.chartEditor2.steps.Data.CSS_CLASS;
