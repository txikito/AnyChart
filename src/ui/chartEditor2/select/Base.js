goog.provide('anychart.ui.chartEditor2.select.Base');

goog.require('anychart.ui.chartEditor2.events');
goog.require('anychart.ui.chartEditor2.select.Renderer');
 ...
 */
anychart.ui.chartEditor2.select.Base = function(opt_caption, opt_menu, opt_renderer, opt_domHelper, opt_menuRenderer) {
  anychart.ui.chartEditor2.select.Base.base(this, 'constructor', opt_caption, opt_menu,
      opt_renderer || anychart.ui.chartEditor2.select.Renderer.getInstance(),
...
goog.inherits(anychart.ui.chartEditor2.select.Base, goog.ui.Select);
 ...
 * @private
 */
anychart.ui.chartEditor2.select.Base.prototype.options_;
 ...
 * @private
 */
anychart.ui.chartEditor2.select.Base.prototype.captions_;
 ...
 * @private
 */
anychart.ui.chartEditor2.select.Base.prototype.icons_;
 ...
 */
anychart.ui.chartEditor2.select.Base.prototype.setOptions = function(value) {
  this.options_ = value;
};
 ...
 * @param {Array.<?string>} value
 */
anychart.ui.chartEditor2.select.Base.prototype.setCaptions = function(value) {
 ...
 * @param {Array.<string>} value
 */
anychart.ui.chartEditor2.select.Base.prototype.setIcons = function(value) {
  this.icons_ = value;
};
 ...
 * Update options.
 */
anychart.ui.chartEditor2.select.Base.prototype.updateOptions = function() {
 ...
 * @return {Array|string}
 */
anychart.ui.chartEditor2.select.Base.prototype.createContentElements = function(option, caption, icon) {
...
/** @override */
anychart.ui.chartEditor2.select.Base.prototype.exitDocument = function() {
  goog.events.unlisten(this, goog.ui.Component.EventType.CHANGE, this.onChange, false, this);

  anychart.ui.chartEditor2.select.Base.base(this, 'exitDocument');
};
 ...
 * @protected
 */
anychart.ui.chartEditor2.select.Base.prototype.onChange = function(evt) {
  evt.preventDefault();
  evt.stopPropagation();
 ...
 * @suppress {visibility}
 */
anychart.ui.chartEditor2.select.Base.prototype.updateCaption = function() {
